...
$string['pluginname'] = 'OpenAI Chat';
$string['modulename'] = 'OpenAI Chat';
$string['modulenameplural'] = 'OpenAI Chats';
$string['modulename_help'] = 'The OpenAI Chat module allows students to interact with an AI assistant within their course. Teachers can monitor usage and view conversation logs.';
$string['openai_chat'] = 'OpenAI Chat';
$string['openai_chatname'] = 'Activity name';
$string['openai_chatname_help'] = 'Enter a name for this OpenAI Chat activity.';
$string['openai_chat:addinstance'] = 'Add a new OpenAI Chat activity';
$string['openai_chat:view'] = 'View OpenAI Chat';
$string['openai_chat:viewreport'] = 'View OpenAI Chat activity report';
$string['openai_chat:viewallreports'] = 'View all OpenAI Chat reports (site-wide)';
...
$string['privacy:metadata:openai_chat_log:instanceid'] = 'The ID of the activity instance.';
...
$string['downloadfilename'] = 'mod_openai_chat_logs';

// Module specific strings.
$string['chatsettings'] = 'Chat settings';
$string['noopenaichats'] = 'No OpenAI Chat activities';
